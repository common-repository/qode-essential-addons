...
- Fixed 'Small Slider' rendering for portfolio single template

= 1.6.1 - 04-07-2024 =
- Fixed possible problem with multiple sliders on same page
- Fixed undefined __experimentalGetPreviewDeviceType function in Gutenberg editor
- Fixed admin tabs mouse drag

= 1.6 - 12-06-2024 =
- Improved admin layout
- Fixed pagination for portfolio archive pages
